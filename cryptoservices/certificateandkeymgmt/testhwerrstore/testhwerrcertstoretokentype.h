...
#ifndef __TESTHWERRSTORETOKENTYPE_H__
#define __TESTHWERRSTORETOKENTYPE_H__

#include <ct.h>

class CTestHWErrStoreTokenType : public CCTTokenType
	{
public:
	static CCTTokenType* NewL();
	virtual ~CTestHWErrStoreTokenType();
