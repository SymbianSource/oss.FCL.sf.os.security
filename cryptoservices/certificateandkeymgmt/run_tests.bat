...
%SECURITYSOURCEDIR%\os\security\cryptomgmtlibs\securitytestfw\test\autotesting\test_launcher.pl -components certman -testreleases udeb -exectimeout \ExecTimeOut.exe -resultsoutput \logs\winscw
)
