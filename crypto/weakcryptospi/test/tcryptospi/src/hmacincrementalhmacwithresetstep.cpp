...
CHmacIncrementalHmacWithResetStep::~CHmacIncrementalHmacWithResetStep()
	{
	}
...
CHmacIncrementalHmacWithResetStep::CHmacIncrementalHmacWithResetStep()
	{
	SetTestStepName(KHmacIncrementalHmacWithResetStep);
	}


TVerdict CHmacIncrementalHmacWithResetStep::doTestStepPreambleL()
	{
...
TVerdict CHmacIncrementalHmacWithResetStep::doTestStepPostambleL()
	{
	return TestStepResult();
	}
